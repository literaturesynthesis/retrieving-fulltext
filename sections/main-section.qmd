...
- Web of Science, Scopus, OpenAlex do not host full text (PDF), only metadata
...
> Check that you retrieve the good articles
...
- Try the [SciPDF](https://github.com/syt2/zotero-scipdf) plugin for Zotero
